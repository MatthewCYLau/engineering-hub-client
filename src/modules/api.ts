...
export const api = axios.create({
  ...
  headers: {
    "x-auth-token":
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyNzZjMmRmYTIxM2YwMDAxNTY4NzU3YiIsImVtYWlsIjoibGF1LmN5Lm1hdHRoZXdAZ21haWwuY29tIiwiam9pbmVkRGF0ZSI6IjIwMjEtMDYtMDdUMDA6MDA6MDAuMDAwWiIsImlhdCI6MTY1MjM1MTEwMX0.knPk7wtofeKvi25YUmYC2ktT5r9axfGQZ-OseXDP5i8",
  },
});
